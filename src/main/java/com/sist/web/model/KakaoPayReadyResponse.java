...
public class KakaoPayReadyResponse implements Serializable{
	...
	private static final long serialVersionUID = -6977409043826200443L;
	...
	private String next_redirect_pc_url; // 요청한 클라이언트가 PC 웹일 경우, 카카오톡 결제 요청 메시지(TMS)를 보내기 위한 사용자 정보 입력 화면 Redirect URL
	...
	private String created_at; // 결제 준비 요청 시간 (Datetime 형식)
